...
// End Cross Module References
	...
	DEFINE_FUNCTION(UMenu::execMenuSetup)
	{
		...
		P_GET_PROPERTY(FStrProperty,Z_Param_PathOfLobby);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->MenuSetup(Z_Param_NumOfPublicConnections,Z_Param_TypeOfMatch,Z_Param_PathOfLobby);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UMenu_MenuSetup_Statics
	{
		...
		static const UECodeGen_Private::FStrPropertyParams NewProp_PathOfLobby;
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMenu_MenuSetup_Statics::NewProp_PathOfLobby = { "PathOfLobby", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(Menu_eventMenuSetup_Parms, PathOfLobby), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnStartSession_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// \xef\xbf\xbd\xef\xbf\xbdSession\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xc9\xb9\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\n" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "\xef\xbf\xbd\xef\xbf\xbdSession\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xc9\xb9\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 411079034
		...
		{ &Z_Construct_UFunction_UMenu_OnStartSession, "OnStartSession" }, // 850403728
	};
#if WITH_METADATA
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_ue_porject_ue_project_game_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue_porject_ue_project_game_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 3515553741U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ue_porject_ue_project_game_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_3516797646(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_ue_porject_ue_project_game_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ue_porject_ue_project_game_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
